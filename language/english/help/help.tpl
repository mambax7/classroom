<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_CLASSROOM_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">This module for managing schools with divisions and classrooms. Each classroom is assigned a user/teacher to manage this classroom.
        The teacher can then create new classes in that classroom and create blocks of certain built-in types for presenting information.<br> <br>
    </p>
