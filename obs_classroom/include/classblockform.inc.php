...
foreach ($classes as $classid => $class) {
    $visible = (isset($settings[$classid]['visible'])) ? $settings[$classid]['visible'] : 0;
    $side = (isset($settings[$classid]['side'])) ? $settings[$classid]['side'] : 0;
    $weight = (isset($settings[$classid]['weight'])) ? $settings[$classid]['weight'] : 0;
