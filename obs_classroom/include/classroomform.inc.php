...
$crform->addElement(new XoopsFormText(_CR_MA_WEIGHT, 'weight', 10, 10, intval($edit_classroom->getVar('weight'))));
...
if ($edit_classroom->getVar('classroomid') > 0) {
    ...
    $moderators = $gperm_handler->getGroupIds('classroom', $edit_classroom->getVar('classroomid'), $xoopsModule->getVar('mid'));
}
