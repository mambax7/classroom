...
$schools = $school_handler->getObjects();
...
$dform->addElement(new XoopsFormText(_CR_MA_WEIGHT, 'weight', 10, 10, intval($edit_division->getVar('weight'))));
...
if ($edit_division->getVar('divisionid') > 0) {
    ...
    $moderators = $gperm_handler->getGroupIds('division', $edit_division->getVar('divisionid'), $xoopsModule->getVar('mid'));
}
