...
class XoopsHeadlineRenderer
{
	...
	function renderBlock($force_update = false)
	{
		...
		$this->_tpl->assign(array('site_name' => $this->_hl->getVar('headline_name'), 'site_url' => $this->_hl->getVar('headline_url'), 'site_id' => $this->_hl->getVar('headline_id'), 'title_length' => $this->_hl->getVar('headline_titlelength')));
		$this->_block =& $this->_tpl->fetch('file:'.XOOPS_ROOT_PATH.'/modules/obs_classroom/templates/cr_blocktype_rss_file.html');
		return true;
	}
