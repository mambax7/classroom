...
class GenericBlock extends ClassroomBlock {

    function GenericBlock() {
        $this->ClassroomBlock();
        $this->assignVar('template', 'cr_blocktype_generic.html');
        $this->assignVar('blocktypename', 'Generic');
    ...
    */
    function buildForm() {
        ...
        $form = new XoopsThemeForm('', 'genericform', 'manage.php');
