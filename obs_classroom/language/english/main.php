...
define('_CR_MA_SCHOOLITEMCOUNT', 'Are you sure you want to IRREVERSIBLY DELETE %s? <br />
                                  This School has <br />
                                  %u Division(s)<br />
                                  %u Classroom(s)<br />
                                  %u Class(es) and<br />
                                  %u Block(s)');
define('_CR_MA_DIVISIONITEMCOUNT', 'Are you sure you want to IRREVERSIBLY DELETE %s? <br />
                                  This Division has <br />
                                  %u Classroom(s)<br />
                                  %u Class(es) and<br />
                                  %u Block(s)');
define('_CR_MA_CLASSROOMITEMCOUNT', 'Are you sure you want to IRREVERSIBLY DELETE %s? <br />
